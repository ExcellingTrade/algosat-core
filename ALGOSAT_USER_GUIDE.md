...
curl http://147.79.67.250:8001/health    # API health
curl http://147.79.67.250:3000           # UI health
```
...
- **Web Dashboard**: `http://147.79.67.250:3000` (or your server IP:3000)
- **API Endpoint**: `http://147.79.67.250:8001` (for advanced integrations)
